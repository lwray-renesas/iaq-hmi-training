...
/* Set value to 1 when using the DTC module generated by Smart Configurator. */
#define CTSU_CFG_DTC_USE_SC                 (0)

/* Auto-judgment function in Snooze mode using SMS. To use, set this to 1. */
...
#define CTSU_CFG_SUMULTI1                   (0x37)
#define CTSU_CFG_SUMULTI2                   (0x47)
